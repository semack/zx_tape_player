...
class _PlayerScreenState extends State<PlayerScreen> {
  ...
  Widget _buildInfoWidget(BuildContext context) {
    return SingleChildScrollView(
        ...
        children: [
          Text(
            _item.source.originalYearOfRelease != null
                ...
                : '',
            style: TextStyle(
                color: Colour('#B1B8C1'), letterSpacing: 0.3, fontSize: 12.0),
          ),
          Text(
            _item.source.originalYearOfRelease != null &&
                    _item.source.genreType != null
                ? ' • '
                : '',
            style: TextStyle(
                color: Colour('#B1B8C1'), letterSpacing: 0.3, fontSize: 12.0),
        ...
        children: [
          ...
          Text(
            _item.source.score.votes != null
                ...
                : tr('na'),
            style: TextStyle(
                color: Colors.white, letterSpacing: 0.3, fontSize: 12.0),
          ),
          SizedBox(width: 20),
          ...
          SizedBox(width: 5),
          Text(
            _item.source.score.score != null && _item.source.score.score > 0
          ...
          Text(
            _item.source.originalPrice != null &&
                    _item.source.originalPrice.currency.replaceAll('/', '') !=
                        'NA'
        ...
        Expanded(
          child: Text(
            _item.source.remarks != null
                ...
                : tr('no_description'),
            style: TextStyle(
                color: Colors.white, letterSpacing: 0.3, fontSize: 14.0),
            maxLines: 256,
          ),
        ),
      ]),
      ...
      Row(children: [
        Text(
            _item.source.authors.where((a) => a.name != null && a.type != null)
                .map((a) => '· ' + a.name + ' - ' + a.type)
                .join('\r\n'),
            style: TextStyle(
                color: Colour('#B1B8C1'), letterSpacing: 0.3, fontSize: 12.0)),
