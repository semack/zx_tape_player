# ZX Tape Player ![appcenter](https://github.com/semack/zx_tape_player/workflows/fastlane-appcenter/badge.svg?branch=beta)
...
## Public Beta 
Public beta is provided by using the [appcenter.ms](https://appcenter.ms) and now available just for Android users and **it's not available for iOS users** regarding the complication of making the AdHoc builds for new testers. Android user can dowmnload test build using [this link](https://install.appcenter.ms/users/semack-owd8/apps/zxtapeplayer.android/distribution_groups/testershttps://install.appcenter.ms/users/semack-owd8/apps/zxtapeplayer.android/distribution_groups/testers).
