...
## Public Beta 
Public beta is provided by [Appcenter](https://appcenter.ms). Beta build are available for Android users only and **not available for Apple users yet** regarding the complication of making the iOS AdHoc builds for new testers. 
